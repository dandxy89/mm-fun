//! Variable-length orderbook message format for efficient batch transmission
//!
//! This format allows sending multiple bid/ask levels in a single message,
//! dramatically reducing the number of ZMQ messages and overhead.
