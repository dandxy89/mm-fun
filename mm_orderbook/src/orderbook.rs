...
/// Heap-allocated orderbook with automatic price sorting
/// Uses BTreeMap for O(log n) insert/update/delete
/// Maintains max 50 levels per side for bounded memory usage
#[derive(Debug, Clone)]
